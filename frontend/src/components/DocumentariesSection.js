        ...
        <div className="container">
          <div className="text-center">
            ...
            <p className="text-xl text-slate-300 max-w-2xl mx-auto">
              Cinematic storytelling meets investigative journalism. 
              Deep dives into the stories that shape our world.
            </p>
          </div>
        </div>
      </section>
          ...
          {articles.length === 0 ? (
            <div className="text-center py-16">
              ...
              <p className="text-slate-400">
                Coming soon: compelling visual stories and investigative documentaries.
              </p>
            </div>
          ) : (
