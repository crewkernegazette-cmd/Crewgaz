...
# Trending Opinions Models
class TrendingOpinion(BaseModel):
    id: Optional[int] = None
    image_url: str
...
class TrendingOpinionResponse(BaseModel):
    opinions: List[dict]
    message: str = "Trending opinions retrieved successfully"

class TrendingOpinionArchive(BaseModel):
    """Response model for archived opinions grouped by month"""
    archive: dict  # { "2025-01": [opinions], "2024-12": [opinions] }
    message: str = "Archive retrieved successfully"
...
ALLOWED_ORIGINS = [
    ...
    "http://localhost:8001",           # Local backend serving frontend
